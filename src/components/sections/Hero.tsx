...
import { ROUTES, SECTION_IDS, PERSONAS } from '@/constants';
...
export const Hero: FC = () => {
  ...
  return (
    <section
      id={SECTION_IDS.home}
      aria-label={t.meta.sectionLabels.hero}
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full z-10">
        ...
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          >
            ...
            <span className="tracking-wide">{t.hero.available}</span>
          </motion.div>
          ...
          >
            {t.hero.hi} <span className="text-gradient-primary">Aman</span>.
            <br />
            <span className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-muted">{t.hero.i}</span>
            <AnimatePresence mode="wait">
              ...
              >
                {mode === PERSONAS.code ? t.hero.buildSoftware : t.hero.chaseStreetFood}
              </motion.span>
            </AnimatePresence>
          </motion.h1>
          ...
          >
            {mode === PERSONAS.code
              ? <>{t.hero.codeDescBefore} <span className="font-semibold text-ink">React</span>, <span className="font-semibold text-ink">Spring Boot</span>, and <span className="font-semibold text-ink">AI agent</span> {t.hero.codeDescAfter}</>
              : <>{t.hero.foodDescBefore} <span className="font-semibold text-ink">@yeh.safar.swaad.ka</span> {t.hero.foodDescAfter}</>
            }
          </motion.p>
            ...
            {mode === PERSONAS.code ? (
              <>
                <MagneticButton strength={0.2}>
                  ...
                  >
                    {t.hero.hireMe} <ArrowRight className="w-5 h-5 ml-2" />
                  </a>
                </MagneticButton>
                <MagneticButton strength={0.2}>
                  <a
              ...
              <>
                <MagneticButton strength={0.2}>
                  ...
                  >
                    ...
                    {t.hero.follow} @{siteConfig.instaHandle}
                  </a>
                </MagneticButton>
                <MagneticButton strength={0.2}>
                  <a
                    ...
                    className="inline-flex items-center justify-center font-display font-semibold rounded-xl-playful border-2 border-ink px-8 py-3.5 text-lg bg-primary-400 text-white hover:bg-primary-300 dark:hover:bg-primary-500 shadow-flat-light dark:shadow-flat-dark active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all duration-150"
                  >
                    {t.hero.viewFoodDiary} <ArrowRight className="w-5 h-5 ml-2" />
                  </a>
                </MagneticButton>
              </>
            )}
          ...
          {mode === PERSONAS.code && (
            ...
            >
              <div className="flex flex-wrap gap-8 items-center">
                {[
                  { target: 10, suffix: '+', label: t.hero.statOpenSource },
                  { target: 2, suffix: '×', label: t.hero.statHackathons },
                  { target: 50, suffix: 'K+', label: t.hero.statFoodCommunity },
                ].map((stat) => (
          ...
          {mode === PERSONAS.code && (
            ...
            >
              <p className="font-mono text-[11px] text-muted uppercase tracking-widest mb-2">{t.hero.stackLabel}</p>
            ...
            {mode === PERSONAS.code ? (
              ...
              >
                ...
                <div className="flex items-center gap-2 border-b border-white/5 px-4 py-3 bg-[#1B1B23] relative z-10">
                  ...
                  <span className="text-xs text-gray-500 font-mono ml-3">{t.hero.codePanelFile}</span>
                ...
                <div className="px-5 py-5 space-y-1.5 text-left leading-relaxed relative z-10">
                  ...
                  <p><span className="text-gray-600 mr-3 select-none">3</span>  <span className="text-[#E06C75]">role</span>: <span className="text-[#98C379]">{`"${t.hero.codePanelRole}"`}</span>;</p>
                  ...
                  <p><span className="text-gray-600 mr-3 select-none">5</span>  <span className="text-[#E06C75]">shipped</span>: <span className="text-[#D19A66]">12</span>+ <span className="text-gray-500">{t.hero.codePanelCommentProduction}</span></p>
                  ...
                  <p><span className="text-gray-600 mr-3 select-none">7</span>  <span className="text-[#E06C75]">status</span>: <span className="text-secondary-400">{`"${t.hero.codePanelStatus}"`}</span>;</p>
                  <p><span className="text-gray-600 mr-3 select-none">8</span>{'}'};</p>
                  <p><span className="text-gray-600 mr-3 select-none">9</span></p>
                  <p><span className="text-gray-600 mr-3 select-none">10</span><span className="text-[#5C6370]">{t.hero.codePanelCommentFuel}</span></p>
                </div>
              ...
              >
                ...
                <div className="pt-5 pb-2 text-left font-display relative z-10">
                  ...
                  <p className="text-sm text-muted mt-1 leading-snug flex items-center gap-1.5">
                    <MapPin className="w-3.5 h-3.5" /> {t.hero.foodLocation}
                  </p>
