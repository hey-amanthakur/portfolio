...
import { Terminal, ChefHat, ArrowRight, Github, Instagram, Sparkles, Code2, Heart, Flame } from 'lucide-react';
          ...
          <div className="flex flex-wrap gap-4 mt-10">
            {mode === 'code' ? (
              ...
              <>
                ...
                >
                  Follow @{siteConfig.instaHandle} <Instagram className="w-5 h-5 ml-2" />
                </a>
                <Button 
                  onClick={(): void => {
